...
//        drawerLayout.setScrimColor(Color.WHITE);
    ...
    public void requestWeather(String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+ weatherId
                + "&key=c3f5e6d9d21a422a83275d2600a1cc99";
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if(weather != null && "ok".equals(weather.status)){
                                ...
                                editor.putString("weather",responseText); // 保存数据到数据库中，以当前包名命名
                                editor.apply();
                                showWeatherInfo(weather);
                            }else{
                                Toast.makeText(WeatherActivity.this,"获取天气信息失败onResponse",Toast.LENGTH_SHORT)
                                        .show();
                            }
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for (Forecast forecast: weather.forecastList) {
            ...
            // 前面设置inflate的第三个参数为false，所以这里需要手动addView
        ...
        carWasText.setText("洗车指数:"+weather.suggestion.carWash.info);
